package com.faranegar.number_stepper;
...
/**
 * Created by rezadaneshvar95 on 7/20/2016.
 */
public class CustomSwipeNumberPicker extends AppCompatTextView {
    ...
    private android.support.v7.app.AlertDialog numberPickerDialog;

    public CustomSwipeNumberPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomSwipeNumberPicker(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        if (attrs != null) {
            try {
                ...
                mNumColor = attrs.getColor(R.styleable.SwipeNumberPicker_snp_numberColor, context.getResources().getColor(R.color.white));
...
//        }
    ...
    private android.support.v7.app.AlertDialog getNumberPickerDialog() {
...
//        }
    ...
    public interface OnValueChangeListener {
        boolean onValueChange(CustomSwipeNumberPicker view, int oldValue, int newValue);
    }
}